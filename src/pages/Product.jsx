      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1 ">
          ...
          <button
            ...
            className="bg-black text-white active:bg-gray-700 text-sm px-8 py-3"
          >
            ADD TO CART
          </button>
